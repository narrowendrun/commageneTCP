...
export default function Layer2({setFilters}){
    ...
    <FilterToggleButton filterName={"MAC"} filter={"ether mac"} setFilters={setFilters} andor={true}/>
    <FilterToggleButton filterName={"VLAN"} filter={"vlan"} setFilters={setFilters} andor={true}/> 
    <FilterToggleButton filterName={"VXLAN"} filter={"vxlan"} setFilters={setFilters} andor={true}/> 
    </>
}